  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-6 lg:grid lg:grid-cols-5 lg:items-start lg:gap-6">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm lg:col-span-2 lg:sticky lg:top-6">
          ...
          {loans.length === 0 ? (
            ...
            <div className="mt-3 overflow-x-auto">
              <table className="w-full min-w-0 text-left text-sm lg:min-w-0">
