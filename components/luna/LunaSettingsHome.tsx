...
type MenuSlug = 'brain' | 'memory' | 'talk' | 'study' | 'teach' | 'exam';
...
export default function LunaSettingsHome({ onSelect, stats = {} }: LunaSettingsHomeProps) {
  ...
  const menus: {
    ...
    { slug: 'exam', name: '평가', desc: '성적표 — 시험 문제, 점수', badge: `문제 ${examCount}/${examTotal}` },
  ];
  ...
  const icon = (slug: MenuSlug) => {
    ...
    switch (slug) {
      ...
      case 'exam': return <svg className={cls} fill="none" stroke="#5F5E5A" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 19v-6M13 19V5M17 19v-9M5 19h16"/></svg>;
    }
  };
    ...
    <div className="bg-gray-50 rounded-xl p-4 md:p-6">
      ...
      <div className="hidden md:block relative mx-auto mt-2" style={{ width: 648, height: 600 }}>
        <svg width="648" height="600" viewBox="0 0 648 600" className="absolute inset-0 pointer-events-none" aria-hidden="true">
          ...
          <path d="M415 105 Q505 155 545 245" fill="none" stroke="#7F77DD" strokeWidth="1.5" markerEnd="url(#luna-arrow)" />
          ...
          <line x1="520" y1="60" x2="440" y2="80" stroke="#888780" strokeWidth="1" strokeDasharray="4 3" />
        ...
        <div className="absolute" style={{ left: 488, top: 16, width: 150 }}><Card m={byId.exam} className="w-full" /></div>
